    ...
    return (
      <main className="review-admin review-admin--login">
        <div className="review-admin-login">
          ...
          <p>Sign in with the Supabase account registered as your review administrator.</p>
          ...
          {reviews.map((review, index) => (
            <article className="review-admin-card" key={review.id}>
              ...
              <dl>
                ...
                <div><dt>EMAIL</dt><dd>{review.email ? <a href={`mailto:${review.email}`}>{review.email}</a> : "Not provided"}</dd></div>
