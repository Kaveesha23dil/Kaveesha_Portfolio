...
const projects = [
  { type: "development", title: "ArchTitan OS", category: "Web Development · Hosting", year: "2026", image: "/project-archtitan.jpeg", href: "/projects/archtitan", live: "https://www.archtitan.tech/", github: "https://github.com/Kaveesha23dil/ArchTitionOS", description: "Developed and hosted the ArchTitan OS website, presenting an adaptive Linux research project through responsive pages, interactive system demonstrations, and GSAP animations." },
  { type: "uiux", title: "Intrinsic Tech", category: "Website Redesign · UI/UX", year: "2026", image: "/mockup-intrinsic-tech.png", href: "/projects/intrinsic-tech", description: "A complete responsive redesign that makes a complex AI consultancy feel clear, credible, and ready for growth.", featured: true },
  { type: "development", title: "GTA VI Experience", category: "Creative Development · GSAP", year: "2025", image: "/mockup-gtavi.png", href: "/projects/gtavi-experience", live: "https://gtavi-landingpage.vercel.app/", github: "https://github.com/Kaveesha23dil/GTAVI_Landingpage", description: "A cinematic responsive website built with GSAP-powered scroll choreography, character sequences, masks, and immersive video transitions." },
  ...
  { type: "development", title: "QuizServer", category: "Full-Stack / Electron", year: "ACADEMIC", image: "/mockup-quizserver.png", href: "/projects/quizserver", description: "A local-network assessment platform for creating, hosting, grading, and analyzing browser-based quizzes across participant devices." },
